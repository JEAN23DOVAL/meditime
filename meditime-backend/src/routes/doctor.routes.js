...
const { getDoctorByIdUser, getDoctorById, getAllDoctorsSortedByNote, getDoctorsByProximity, updateDoctorExtraInfo, searchDoctorsController } = require('../controllers/doctor.controller');
...
// Route pour la recherche de médecins
router.get('/', searchDoctorsController);
